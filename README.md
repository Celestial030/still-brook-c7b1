...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-brook-c7b1)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/still-brook-c7b1
```

A live public deployment of this template is available at [https://still-brook-c7b1.templates.workers.dev](https://still-brook-c7b1.templates.workers.dev)
